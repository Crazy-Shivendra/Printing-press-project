...
--
-- Host: localhost    Database: printing_press_db
-- ------------------------------------------------------
...
CREATE TABLE `customizations` (
  ...
  CONSTRAINT `customizations_ibfk_1` FOREIGN KEY (`cart_item_id`) REFERENCES `cart_items` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-01-06 18:52:29
